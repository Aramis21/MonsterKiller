 ...
 */
public class EscenaNvl3 extends EscenaBase implements IAccelerationListener {
    ...
    public void cargarRecursos() {
        ...
        regionMonstruo4 = cargarImagenMosaico("Monster2.png", 969, 301, 1, 5);
        regionMonstruo5 = cargarImagenMosaico("Monster1.png", 800, 198, 1, 6);
    ...
    private void agregarMonstruos(){
        ...
        Monstruos monstruo = new Monstruos(monster, 2, -9, -8);
        ...
        Monstruos monstruo3 = new Monstruos(monster3, 2, -9, -6);
    ...
    private void perderPila(){
        ...
        if (tiempo > 6f && tiempo <=11f && !bat4Visible){
        ...
        if (tiempo > 11f && tiempo <=16f && !bat3Visible){
        ...
        if (tiempo > 16f && tiempo <=21f && !bat2Visible){
        ...
        if (tiempo >21f && tiempo <= 26f && !bat1Visible){
        ...
        if (tiempo >26f && tiempo <=31.1f && !bat0Visible){
        ...
        if (tiempo >= 31.1f && !gameOver && !gameWin){
