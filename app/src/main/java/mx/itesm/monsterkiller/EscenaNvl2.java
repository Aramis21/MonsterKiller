 ...
 */
public class EscenaNvl2 extends EscenaBase implements IAccelerationListener {
    ...
    public void cargarRecursos() {
        regionFondo = cargarImagen("CuartoNina.png");
    ...
    private void perderPila(){
        ...
        if (tiempo >28f && tiempo <=32.1f && !bat0Visible){
        ...
        if (tiempo >= 32.1f && !gameOver && !gameWin){
