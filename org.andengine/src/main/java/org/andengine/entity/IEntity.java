...
public interface IEntity extends IDrawHandler, IUpdateHandler, IDisposable, ITouchArea {
	...
	int TAG_DEFAULT = 0;
	int ZINDEX_DEFAULT = 0;

	float OFFSET_CENTER_X_DEFAULT = 0.5f;
	float OFFSET_CENTER_Y_DEFAULT = 0.5f;

	float ROTATION_DEFAULT = 0;
	float ROTATION_CENTER_X_DEFAULT = 0.5f;
	float ROTATION_CENTER_Y_DEFAULT = 0.5f;

	float SCALE_X_DEFAULT = 1;
	float SCALE_Y_DEFAULT = 1;
	float SCALE_CENTER_X_DEFAULT = 0.5f;
	float SCALE_CENTER_Y_DEFAULT = 0.5f;

	float SKEW_X_DEFAULT = 0;
	float SKEW_Y_DEFAULT = 0;
	float SKEW_CENTER_X_DEFAULT = 0.5f;
	float SKEW_CENTER_Y_DEFAULT = 0.5f;
	...
	float getOffsetCenterX();
	float getOffsetCenterY();
	void setOffsetCenterX(final float pOffsetCenterX);
	void setOffsetCenterY(final float pOffsetCenterY);
	void setOffsetCenter(final float pOffsetCenterX, final float pOffsetCenterY);
	...
	boolean isRotatedOrScaledOrSkewed(); // TODO What about the new offset?

	void setAnchorCenterX(final float pAnchorCenterX);
	void setAnchorCenterY(final float pAnchorCenterY);
	void setAnchorCenter(final float pAnchorCenterX, final float pAnchorCenterY);
	...
	void setColor(final int pARGBPackedInt);
	 ...
	 * @return a shared(!) float[] of length 2.
	 */
	float[] convertLocalCoordinatesToParentCoordinates(final float pX, final float pY);
	/**
	 * @param pX
	 * @param pY
	 * @param pReuse must be of length 2.
	 * @return <code>pReuse</code> as a convenience.
	 */
	float[] convertLocalCoordinatesToParentCoordinates(final float pX, final float pY, final float[] pReuse);
	/**
	 * @param pCoordinates must be of length 2.
	 * @return a shared(!) float[] of length 2.
	 */
	float[] convertLocalCoordinatesToParentCoordinates(final float[] pCoordinates);
	/**
	 * @param pCoordinates must be of length 2.
	 * @param pReuse must be of length 2.
	 * @return <code>pReuse</code> as a convenience.
	 */
	float[] convertLocalCoordinatesToParentCoordinates(final float[] pCoordinates, final float[] pReuse);
	 ...
	 * @return a shared(!) float[] of length 2.
	 */
	float[] convertParentCoordinatesToLocalCoordinates(final float pX, final float pY);
	/**
	 * @param pX
	 * @param pY
	 * @param pReuse must be of length 2.
	 * @return <code>pReuse</code> as a convenience.
	 */
	float[] convertParentCoordinatesToLocalCoordinates(final float pX, final float pY, final float[] pReuse);
	/**
	 * @param pCoordinates must be of length 2.
	 * @return a shared(!) float[] of length 2.
	 */
	float[] convertParentCoordinatesToLocalCoordinates(final float[] pCoordinates);
	/**
	 * @param pCoordinates must be of length 2.
	 * @param pReuse must be of length 2.
	 * @return <code>pReuse</code> as a convenience.
	 */
	float[] convertParentCoordinatesToLocalCoordinates(final float[] pCoordinates, final float[] pReuse);
	 ...
	 * @return a shared(!) float[] of length 2.
	 */
	float[] convertLocalCoordinatesToSceneCoordinates(final float pX, final float pY);
	/**
	 * @param pX
	 * @param pY
	 * @param pReuse must be of length 2.
	 * @return <code>pReuse</code> as a convenience.
	 */
	float[] convertLocalCoordinatesToSceneCoordinates(final float pX, final float pY, final float[] pReuse);
	/**
	 * @param pCoordinates must be of length 2.
	 * @return a shared(!) float[] of length 2.
	 */
	float[] convertLocalCoordinatesToSceneCoordinates(final float[] pCoordinates);
	/**
	 * @param pCoordinates must be of length 2.
	 * @param pReuse must be of length 2.
	 * @return <code>pReuse</code> as a convenience.
	 */
	float[] convertLocalCoordinatesToSceneCoordinates(final float[] pCoordinates, final float[] pReuse);
	 ...
	 * @return a shared(!) float[] of length 2.
	 */
	float[] convertSceneCoordinatesToLocalCoordinates(final float pX, final float pY);
	/**
	 * @param pX
	 * @param pY
	 * @param pReuse must be of length 2.
	 * @return <code>pReuse</code> as a convenience.
	 */
	float[] convertSceneCoordinatesToLocalCoordinates(final float pX, final float pY, final float[] pReuse);
	/**
	 * @param pCoordinates must be of length 2.
	 * @return a shared(!) float[] of length 2.
	 */
	float[] convertSceneCoordinatesToLocalCoordinates(final float[] pCoordinates);
	/**
	 * @param pCoordinates must be of length 2.
	 * @param pReuse must be of length 2.
	 * @return <code>pReuse</code> as a convenience.
	 */
	float[] convertSceneCoordinatesToLocalCoordinates(final float[] pCoordinates, final float[] pReuse);
	...
	boolean collidesWith(final IEntity pOtherEntity);
